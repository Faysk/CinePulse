...
$Archive = Join-Path $ProjectRoot 'dist\CinePulse-1.0.0-rc.4-windows-portable.zip'
...
try {
    ...
    $Stage = Join-Path $Target '.runtime\updates\1.0.0-rc.4\extracted\CinePulse'
    ...
    @{ schema = 1; version = '1.0.0-rc.4'; source = $Stage } | ConvertTo-Json |
