...
Antes de uma release, fixe versão, URL oficial, tamanho e SHA-256 dos artefatos Stable em `installer/bootstrap-manifest.json`; componentes experimentais usam o contrato separado `installer/experimental-components.json`. Licença e permissão de redistribuição continuam sendo verificadas por componente. Se a redistribuição não estiver claramente permitida, o instalador deve direcionar o usuário à fonte oficial ou fazer download sob solicitação, sem espelhar o arquivo.
